    ...
    <>
      <header className="text-center" id="home">
        <div className="container-fluid pt-5">
          <div className="row">
            <div className="head-img animate__animated animate__bounceIn animate__slower  col-md-4 col-sm-12 ">
              <img src="./imgs/head.jpeg" alt="" width="100%" className="" />
            </div>
            <div className="head-item d-flex justify-content-center align-items-center flex-column col-md-8 col-sm-12">
              <h2 className="">منصة متكاملة في الكيمياء</h2>
              <p className="job-title  fw-semibold position-relative"></p>
              <h5 className="text-muted pt-2 ">
                موقع البروفسير في الكيمياء منصة أونلاين عربية متخصصة بالكيمياء
                لجميع المراحل الثانويه العامةو الأزهرية
              </h5>
              <button
                onClick={showAlert}
                className="btn btn-outline-primary btn-raduis px-5 fw-bold my-3"
                aria-pressed="true"
              >
                اشترك الان
              </button>
        ...
        <a href="#courses" onClick={handleScroll}>
